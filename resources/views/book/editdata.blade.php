...
<html lang="en">
  ...
  <body>
    <section class="form-data">
        <div class="container">
            <h1 class="text-center">Update Data Books</h1>
            <form action="{{route('update.book', $buku->id)}}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{$buku->page}}" id="page" name="page" required>
                </div>
                <div class="mb-3">
                    <label for="year" class="form-label">Year Book</label>
                    <input type="text" class="form-control" value="{{$buku->year}}" id="year" name="year" required>
                </div>
